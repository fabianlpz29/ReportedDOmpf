...
//productos ingresados los ultimos 3 meses
$filtro2 = "SELECT * FROM tbl_invesproduct WHERE introduccion >= DATE_SUB(CURDATE(), INTERVAL 3 MONTH)";
$resultado = mysqli_query($conexion, $filtro2);

$archivo = 'Productos-ingrados-ult3meses'.date('Ymd_His').'.pdf';
